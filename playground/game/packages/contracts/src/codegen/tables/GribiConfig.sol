...
library GribiConfig {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "GribiConfig", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004772696269436f6e6669670000000000);
   ...
   */
  function encode(address contractAddress) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
